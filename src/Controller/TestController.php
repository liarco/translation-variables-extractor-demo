...
class TestController extends AbstractController
{
    ...
    public function domain(TranslatorInterface $translator): Response
    {
        return $this->render('test/domain.html.twig', [
            ...
            'unsupported_translations' => [
                t('D_php_t_empty_array', [], 'my-domain'),
                t('D_php_t_with_param_one_line', ['var1' => 'val1'], 'my-domain'),
                t('D_php_t_with_params_one_line_no_trailing_comma', ['var1' => 'val1', 'var2' => 'val2'], 'my-domain'),
                t('D_php_t_with_params_one_line_with_trailing_comma', ['var1' => 'val1', 'var2' => 'val2',], 'my-domain'),
